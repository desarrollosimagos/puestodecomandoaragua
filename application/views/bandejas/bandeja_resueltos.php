<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Bandeja resueltos</h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url() ?>home">Inicio</a>
            </li>
            <li class="active">
                <strong>Bandeja resueltos</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Bandeja resueltos </h5>
                    <input type="hidden" id="base_url" value="<?php echo base_url(); ?>">
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tab_resueltos" class="table table-striped table-bordered dt-responsive table-hover dataTables-example" >
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Solicitante</th>
						...
						<input type="hidden" id="ruta_origen" value="bandeja_resueltos">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Cierre Modal para descripción del movimiento -->
 ...
 <!-- Page-Level Scripts -->
<script src="<?php echo assets_url(); ?>script/bandeja_resueltos.js"></script>
