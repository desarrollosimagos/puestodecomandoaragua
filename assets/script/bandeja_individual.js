$(document).ready(function(){
    ...
    // Función para cambiar un twitter a la bandeja de respuestas, asignado al perfil indicado
	$("table#tab_individuales").on('click', 'a.observacion', function (e) {
	...
	$("#asignar").on('click', function (e) {
		...
		if($("#detalles").val().trim() == ''){
			...
			$.post(base_url+'individuales/cambiar_bandeja', {'id':$("#id_tweet").val(), 'nueva_bandeja':$("#nueva_bandeja").val(), 'mensaje':$("#detalles").val(), 'id_perfil':$("#id_perfil").val(), 'get_ids':$("#get_ids").val()}, function (response) {
