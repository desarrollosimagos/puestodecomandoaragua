$(document).ready(function(){
	...
	$("#asignar").on('click', function (e) {
		...
		if($("#detalles").val().trim() == ''){
			...
			$.post(base_url+'respuestas/cambiar_bandeja', {'id':$("#id_tweet").val(), 'nueva_bandeja':$("#nueva_bandeja").val(), 'mensaje':$("#detalles").val(), 'id_perfil':$("#id_perfil").val(), 'get_ids':$("#get_ids").val()}, function (response) {
